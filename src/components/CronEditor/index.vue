...
import MonthDays from './core/MonthDays'
import WeekDays from './core/WeekDays'
...
export default {
	...
	methods: {
		...
		changePeriod(val) {
			const { months, monthDays, weekDays, hours, minutes, humanizeValue } =
				this
		...
		changeMonths(val) {
			const { period, monthDays, weekDays, hours, minutes, humanizeValue } =
				this
			const cron = getCronStringFromValues(
				period,
				val,
		...
		changeHours(val) {
			const { period, months, monthDays, weekDays, minutes, humanizeValue } =
				this
			const cron = getCronStringFromValues(
				period,
				months,
