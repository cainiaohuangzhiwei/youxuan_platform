...
;(function () {
	...
	window.UMEDITOR_HOME_URL =
		window.YOUXUAN_CONFIG.static.prefix + '/umeditor1.2/'
	var URL =
		window.UMEDITOR_HOME_URL ||
		(function () {
			function PathStack() {
	...
	// var HOST_URL = 'https://test.yunhuotong.net/yhtplus/' //这里写死项目路径
	// var HOST_URL = '/yhtplus/' //这里写死项目路径
	// var userId = '';
	// var userId = window.localStorage.getItem('yhtplusUserId') || '';
	// var sessionKey = window.localStorage.getItem('yhtplusSessionKey') || '';
	// var sessionKey = '';
	// console.log(userId,sessionKey,UMEDITOR_HOME_URL,URL);
	/**
